"""
Helper classes to handle the process of normalizing the 10k cats dataset.
...
class ImageWithKeypoints(object):
    ...
    def resize(self, new_height, new_width):
        ...
        self.image_arr = cv2.resize(self.image_arr, (new_height, new_width)) 
